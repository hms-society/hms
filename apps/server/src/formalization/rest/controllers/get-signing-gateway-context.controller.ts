...
import { Get, Inject, Res, Req, UseGuards } from '@nestjs/common'
...
import type { GatewayRequest } from './signing-gateway.controller'
import { FLOW_COOKIE, DEVICE_COOKIE } from './signing-gateway.controller'

@SigningGatewayRoute()
export class GetSigningGatewayContextController extends SigningGatewayController {
