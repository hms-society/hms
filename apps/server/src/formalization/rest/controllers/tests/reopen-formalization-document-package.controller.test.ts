...
describe('Reopen Formalization Document Package Controller [PATCH /formalizations/:formalizationId/documents/reopen]', () => {
  ...
  it('rejects an invalid expected version before application dispatch', async () => {
    const response = await request(fixture.app.getHttpServer())
      .patch('/formalizations/00000000-0000-4000-8000-000000000001/documents/reopen')
