...
describe('Save Formalization Contract Form Draft Controller [PATCH /formalizations/:formalizationId/contract-form/draft]', () => {
  ...
  it('rejects an invalid Formalization identifier at the HTTP boundary', async () => {
    const response = await request(fixture.app.getHttpServer())
      .patch('/formalizations/not-a-uuid/contract-form/draft')
      .send({})
