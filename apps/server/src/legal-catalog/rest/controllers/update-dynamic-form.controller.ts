...
import {
  UpdateDynamicFormUseCase,
  ValidateDynamicFormDefinitionUseCase,
} from '@hms/core/legal-catalog/use-cases'
import { updateDynamicFormSchema } from '@hms/validation/legal-catalog'
...
type Request = Parameters<UpdateDynamicFormUseCase['execute']>[0]
...
export class UpdateDynamicFormController {
  private readonly useCase: UpdateDynamicFormUseCase
  ...
  constructor(
    ...
    this.useCase = new UpdateDynamicFormUseCase(
  ...
  @Put('dynamic-forms/:dynamicFormId')
  ...
  handle(
    ...
    @Body(new ZodValidationPipe(updateDynamicFormSchema)) body: RequestBody,
