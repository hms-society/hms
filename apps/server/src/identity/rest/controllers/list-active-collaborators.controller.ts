...
import { ListActiveCollaboratorsUseCase } from '@hms/core/identity/use-cases'
...
export class ListActiveCollaboratorsController {
  private readonly useCase: ListActiveCollaboratorsUseCase

  constructor(
    @Inject(IDENTITY_REPOSITORIES.collaborators)
    collaboratorsRepository: CollaboratorsRepository,
  ) {
    this.useCase = new ListActiveCollaboratorsUseCase(collaboratorsRepository)
  }
  ...
  @ApiResponse({
    ...
    description: 'The active collaborators were returned successfully.',
  ...
  handle(@Query() query: ListActiveCollaboratorsControllerRequestQuery) {
