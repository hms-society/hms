...
export * from '@/shared/database/drizzle/models/communication-channel-model'
export * from '@/shared/database/drizzle/models/stored-file-model'
...
export * from '@/formalization/database/drizzle/models'
