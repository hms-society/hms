...
CREATE TABLE IF NOT EXISTS "document_exception_audit_logs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "document_exception_audit_logs"
	ADD CONSTRAINT "document_exception_audit_logs_document_exception_id_document_exceptions_id_fk"
	FOREIGN KEY ("document_exception_id") REFERENCES "public"."document_exceptions"("id") ON DELETE cascade ON UPDATE no action;
