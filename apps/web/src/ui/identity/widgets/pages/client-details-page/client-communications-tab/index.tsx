...
import {
  ...
  useClientCommunicationsTab,
} from './use-client-communications-tab'

export type { ClientCommunicationsTabProps } from './use-client-communications-tab'
...
export const ClientCommunicationsTab = ({ clientId }: ClientCommunicationsTabProps) => {
  const {
    ...
    periodFilter,
    typeFilter,
  } = useClientCommunicationsTab({ clientId })
