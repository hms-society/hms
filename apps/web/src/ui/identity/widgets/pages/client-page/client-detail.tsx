...
export function ClientDetailsPage({ clientId }: ClientDetailsPageProps) {
  ...
  if (isLoadingClient || isLoadingIntakes) {
    return (
      <div className='mx-auto flex w-full max-w-5xl flex-col items-center justify-center gap-6 mt-12 py-12'>
  ...
  return (
    <div className='mx-auto flex w-full max-w-5xl flex-col gap-6 mt-12 px-4 sm:px-0'>
      <Anchor
        route='clients'
