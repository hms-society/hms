    ...
    <div className='flex flex-col gap-6 p-6'>
        ...
        <div className='flex items-start gap-3 rounded-md border border-[#A5D6A7] bg-[#E8F5E9]/50 p-4'>
          ...
          <div className='flex flex-1 flex-col'>
            ...
            <span className='mt-0.5 font-sans text-xs text-[#1B5E20]/70'>
              Enviado para Mariana Costa Silva por e-mail hoje às 14:48.
            </span>
          </div>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <div className='flex flex-col gap-3'>
          {(
            [
              ['Titular', 'Mariana Costa Silva', 'user'],
              ['CPF', '284.***.***-19', 'credit-card'],
              ['Endereço', 'Rua das Palmeiras, 147', 'map-pin'],
              ['CEP', '01452-001', 'map'],
          ...
          <div className='flex items-start gap-3 rounded-md border border-[#FDECC8] bg-[#FFF8EB] p-3'>
            ...
            <div className='flex flex-col'>
              <span className='font-sans text-xs font-semibold text-[#7C4700]'>
                Data de emissão não identificada
              </span>
              <span className='font-sans text-[10px] text-[#7C4700]/70'>
                Campo obrigatório antes da validação.
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='flex min-h-[700px] flex-col overflow-hidden rounded-xl border border-border bg-card shadow-card'>
          <div className='flex items-center justify-between border-b border-border p-5'>
            <div className='flex flex-col gap-1.5'>
              ...
              <span className='font-sans text-xs text-muted-foreground'>
                {mockDocument.receivedFrom} • {mockDocument.contactInfo} • recebido{' '}
                {mockDocument.receivedDate} às {mockDocument.receivedTime}
              </span>
            </div>
            <Badge
              variant='secondary'
              className={`gap-1.5 rounded-pill border-0 px-3 py-1 font-sans text-[11px] font-semibold ${getStatusStyles(documentStatus)}`}
            >
