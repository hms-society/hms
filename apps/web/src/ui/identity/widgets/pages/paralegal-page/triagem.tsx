...
export function Triagem() {
  ...
  const handleConfirmRejection = () => {
    ...
    setBatches((prev) =>
      prev.map((b) =>
        b.id === rejectingBatch.id ? { ...b, status: 'rejected', rejectionReason } : b,
      ),
    )
                  ...
                  filteredPeople.map((person) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex w-full items-center justify-between p-3 rounded-2xl border cursor-pointer transition-all text-left ${
                          isSelected
        ...
        <DialogContent className='w-[92vw] sm:max-w-md p-4 sm:p-6 rounded-3xl bg-white border-none shadow-xl flex flex-col items-center text-center gap-4 sm:gap-5 [&>button]:hidden font-sans'>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-xs text-slate-500 font-sans leading-relaxed px-1 sm:px-2'>
              ...
              serão arquivados e o remetente não será notificado. Esta ação pode ser
          ...
          <div className='w-full space-y-1.5 text-left'>
            <label
              ...
              className='text-xs font-bold font-sans text-slate-700'
            >
