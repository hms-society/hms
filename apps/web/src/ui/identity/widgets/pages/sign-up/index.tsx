...
export const SignUpPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const cpfOrEmail = formData.get('cpf-email')?.toString() ?? ''

    console.log(cpfOrEmail)
  }
      ...
      <div className="hidden md:flex w-[45%] flex-col justify-between bg-gradient-to-br from-primary to-brand p-12 lg:p-16">
        ...
        <div className="-mt-10 flex flex-col gap-6">
          ...
          <p className="max-w-[380px] font-sans text-[16px] leading-relaxed text-primary-foreground/80">
            Acompanhe seu processo, converse com seu advogado e tire dúvidas
            quando precisar — sem juridiquês, sem complicação.
          </p>
        </div>
        ...
        <div className="flex w-full max-w-[420px] flex-col gap-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="mt-1 font-sans text-[15px] leading-relaxed text-muted-foreground">
              Entre com seus dados para continuar. Se precisar de ajuda, estamos
              por perto.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="cursor-pointer font-sans text-[13px] font-bold text-brand-accent transition-opacity hover:opacity-80"
                >
                  Esqueci minha senha
                </button>
              </div>
            ...
            <Button
              type="submit"
              className="mt-2 h-12 w-full rounded-full bg-brand font-sans text-[15px] font-bold text-brand-foreground shadow-none transition-opacity hover:opacity-90"
            >
