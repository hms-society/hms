    ...
    <div className='min-h-screen bg-white font-sans'>
      <header className='flex items-center justify-between px-5 py-4 border-b border-gray-100'>
        <div className='flex flex-col'>
          <img
            src='/images/logo-hms.png'
            alt='HMS Sociedade de Advogados'
        ...
        <nav className='flex items-center gap-8'>
          <a
            href='#sobre'
            className='hidden md:block text-brand font-serif text-[1rem] font-bold hover:opacity-75 transition-opacity'
          >
            Sobre nós
          </a>
          <a
      ...
      <section className='relative overflow-hidden grid grid-cols-1 md:grid-cols-[4fr_3fr] px-8 md:px-18 pt-14 pb-14'>
        <div className='flex flex-col gap-6 z-10'>
          ...
          <div className='flex flex-col gap-3'>
            <p className='text-gray-600 font-sans text-[15px] md:text-[20px] font-normal leading-normal max-w-md'>
              Assessoria jurídica completa para pessoas físicas e empresas, com
              transparência em cada etapa do seu processo.
            </p>
            <p className='text-gray-600 font-sans text-[15px] md:text-[20px] font-normal leading-normal max-w-sm'>
              Nossa equipe acompanha seu caso de perto, mantendo você informado e seguro
              em todas as decisões.
            </p>
          </div>
          <div>
            <Button
              className='flex items-center gap-2 bg-brand hover:bg-[#1a6b70] px-10 py-5 rounded-lg transition-colors cursor-pointer w-fit'
              asChild
            >
              <Link to='/'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-8xl mt-25'>
            <div className='flex flex-col gap-2'>
              ...
              <p className='font-sans text-[14px] lg:text-[18px] font-normal text-gray-600 leading-normal'>
                Atuamos nas principais áreas do direito trabalhista, com expertise
                construída ao longo de mais de uma década de atuação
              </p>
            </div>
            <div className='flex flex-col gap-2'>
              <div className='w-12 h-0.5 bg-brand' />
              <p className='font-sans text-[14px] lg:text-[18px] font-normal text-gray-600 leading-normal'>
                Utilizamos tecnologia para manter você atualizado sobre cada movimentação
                do seu processo, com comunicação direta e ágil
              </p>
            </div>
            <div className='flex flex-col gap-2'>
              <div className='w-12 h-0.5 bg-brand' />
              <p className='font-sans text-[14px] lg:text-[18px] font-normal text-gray-600 leading-normal'>
                Atendimento personalizado e humanizado, porque cada caso é único e merece
                atenção dedicada
              </p>
            </div>
          </div>
        ...
        <div className='absolute top-0 right-0 hidden md:block'>
          <img
            src='/images/triangulos-landing.png'
      ...
      <section
        id='sobre'
        className='bg-brand px-8 md:px-24 py-15 pt-4 min-h-[85vh] flex flex-col justify-center'
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6'>
          <Card className='bg-card-surface border-none'>
            ...
            <CardContent>
              <p className='font-sans text-[16px] text-gray-700 leading-normal'>
                Organizamos todo o relacionamento jurídico, do primeiro contato à entrega
                final.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className='bg-card-surface border-none'>
            ...
            <CardContent>
              <p className='font-sans text-[16px] text-gray-700 leading-normal'>
                A tecnologia acelera o processo, enquanto a equipe jurídica garante a
                qualidade.
              </p>
            </CardContent>
          </Card>
          <Card className='bg-card-surface border-none'>
            ...
            <CardContent>
              <p className='font-sans text-[16px] text-gray-700 leading-normal'>
                Orientamos decisões com base em análise jurídica aprofundada e visão de
                negócio.
              </p>
            </CardContent>
          </Card>
          <Card className='bg-card-surface border-none'>
            ...
            <CardContent>
              <p className='font-sans text-[16px] text-gray-700 leading-normal'>
                Monitore cada etapa do seu processo com atualizações automáticas e
                transparentes.
              </p>
            </CardContent>
          </Card>
          <Card className='bg-card-surface border-none'>
            ...
            <CardContent>
              <p className='font-sans text-[16px] text-gray-700 leading-normal'>
                Canal direto com sua equipe jurídica, sem burocracia e com respostas
                rápidas.
              </p>
            </CardContent>
          </Card>
        ...
        <div className='px-10 md:px-24 grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
          <div className='flex flex-col gap-8'>
            ...
            <p className='font-sans text-[18px] font-normal text-gray-500 leading-relaxed'>
              Agende uma consulta e descubra como podemos cuidar do seu caso com dedicação
              e transparência.
            </p>
            <Button
              variant='outline'
              className='w-fit px-12 py-6 rounded-full border-2 border-brand text-brand font-serif text-lg font-bold hover:bg-brand hover:text-white transition-colors cursor-pointer'
      ...
      <div className='bg-white px-8 md:px-24 py-8 flex items-center justify-between border-t border-gray-200'>
        ...
        <div className='flex items-center gap-2'>
          <Link
            to='/'
            className='font-sans text-[10px] md:text-[14px] text-gray-500 hover:text-brand transition-colors'
          >
