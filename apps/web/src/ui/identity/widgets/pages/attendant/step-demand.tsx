    ...
    <div className="flex flex-col gap-5">
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          />
          {errors.origem && <span className="text-[12px] text-destructive">{errors.origem.message}</span>}
        </div>

        <div className="flex flex-col gap-1.5">
          <Label>Canal de contato <span className="text-destructive">*</span></Label>
          <Controller
            name="canal"
            control={control}
            render={({ field }) => (
          ...
          />
          {errors.canal && <span className="text-[12px] text-destructive">{errors.canal.message}</span>}
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="flex flex-col gap-1.5">
          <Label>Área jurídica <span className="text-destructive">*</span></Label>
          <Controller
            name="areaJuridica"
            control={control}
            render={({ field }) => (
          ...
          />
          {errors.areaJuridica && <span className="text-[12px] text-destructive">{errors.areaJuridica.message}</span>}
        </div>

        <div className="flex flex-col gap-1.5">
          <Label>Tema jurídico <span className="text-destructive">*</span></Label>
          <Controller
            name="temaJuridico"
            control={control}
            render={({ field }) => (
              <Select onValueChange={field.onChange} value={field.value ?? ''}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="acidente_de_trabalho">Acidente de trabalho</SelectItem>
          ...
          />
          {errors.temaJuridico && <span className="text-[12px] text-destructive">{errors.temaJuridico.message}</span>}
        </div>

        <div className="flex flex-col gap-1.5">
          <Label>Grau de urgência <span className="text-destructive">*</span></Label>
          <Controller
            name="urgencia"
            control={control}
            render={({ field }) => (
          ...
          />
          {errors.urgencia && <span className="text-[12px] text-destructive">{errors.urgencia.message}</span>}
        </div>
      </div>
