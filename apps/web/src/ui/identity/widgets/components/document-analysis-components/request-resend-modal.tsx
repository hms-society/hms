      ...
      <DialogContent className="w-[calc(100%-2rem)] !max-w-3xl gap-0 p-0 sm:rounded-2xl">
        ...
        <div className="flex flex-col gap-6 p-6">
          <div className="flex flex-col gap-3">
            <span className="font-sans text-sm font-semibold text-foreground">Destinatário</span>
            <div className="flex items-center gap-4 rounded-xl border border-border bg-[#F8F9FA] p-4">
              ...
              <div className="flex flex-col">
                <span className="font-sans text-sm font-bold text-foreground">{recipientName}</span>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <span className="font-sans text-sm font-semibold text-foreground">Motivo da recusa</span>
              <Badge variant="secondary" className="bg-[#E1F5F6] text-[#0F5C61] hover:bg-[#E1F5F6] border-0 text-[10px] rounded-pill px-2.5">
                Automático
              </Badge>
            </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <span className="font-sans text-sm font-semibold text-foreground">Mensagem ao remetente</span>
        ...
        <DialogFooter className="border-t border-border p-6 sm:justify-end">
          <Button type="button" variant="outline" className="rounded-pill font-sans text-sm h-11 px-6 font-semibold" onClick={onClose}>
            Cancelar
          </Button>
          <Button type="button" variant="brand" className="rounded-pill font-sans text-sm h-11 gap-2 px-6 font-semibold" onClick={() => onSend(message)}>
