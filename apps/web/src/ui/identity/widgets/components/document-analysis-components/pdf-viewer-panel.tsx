...
export const PdfViewerPanel = ({ fileSize, integrity, duplicity }: PdfViewerPanelProps) => {
  return (
    <section className="flex flex-col bg-muted/10 p-5">
      <div className="flex items-center justify-between pb-4">
        <h2 className="font-sans text-sm font-semibold text-foreground">Documento original</h2>
      ...
      <div className="flex flex-1 flex-col items-center justify-center rounded-xl bg-muted/30 p-8 shadow-inner">
        ...
        <Badge variant="outline" className="mt-4 bg-card px-3 py-1 text-[10px] text-muted-foreground shadow-sm">
          Página 1 de 1
        </Badge>
      </div>
      ...
      <div className="mt-5 grid grid-cols-3 gap-4 rounded-xl bg-card p-4 shadow-sm border border-border">
        <div className="flex flex-col gap-0.5">
          ...
          <span className="font-sans text-xs font-semibold text-foreground">PDF - {fileSize}</span>
        </div>
        <div className="flex flex-col gap-0.5">
          <span className="font-sans text-[10px] text-muted-foreground">Integridade do arquivo</span>
          <span className="font-sans text-xs font-semibold text-foreground">{integrity}</span>
        </div>
        <div className="flex flex-col gap-0.5">
          <span className="font-sans text-[10px] text-muted-foreground">Duplicidade</span>
          <span className="font-sans text-xs font-semibold text-foreground">{duplicity}</span>
        </div>
      </div>
    </section>
  )
