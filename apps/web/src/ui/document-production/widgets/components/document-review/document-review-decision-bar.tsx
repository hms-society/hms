...
} from '../document-status-chip'
import type { DocumentReviewViewModel } from './types'

export type DocumentReviewDecisionBarProps = {
...
export const DocumentReviewDecisionBar = ({
  viewModel,
  isEditing,
  isSaving,
  ...
  isReadOnly = false,
}: DocumentReviewDecisionBarProps) => {
          ...
          <>
            ...
            {viewModel.isInReview && (
              <>
                <Button
                  ...
                  size='sm'
                  className={DECISION_ACTION_CLASS}
                  disabled={isSubmittingDecision || isReadOnly}
                  onClick={onReject}
                >
            ...
            {viewModel.isApproved && !viewModel.isCurrent && (
              <Button
                ...
                size='sm'
                className={DECISION_ACTION_CLASS}
                disabled={isSelectingCurrent || isReadOnly}
