...
export function SelectConsultationDocumentsDialog({
  open,
  options,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='min-w-0 max-h-[calc(100vh-1.5rem)] gap-0 overflow-y-auto p-0 sm:max-w-3xl [&_[data-slot=dialog-close]]:rounded-full [&_[data-slot=dialog-close]]:bg-muted/60'>
        <DialogHeader className='min-w-0 border-b border-border px-6 py-5 pr-16'>
          ...
          <DialogDescription>
            Escolha um ou mais modelos para adicionar à consulta.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className='min-w-0 space-y-4 px-6 py-5'>
          ...
          <div className='grid gap-3 sm:grid-cols-2'>
            <div className='space-y-1.5'>
              <label className='text-sm font-semibold' htmlFor='consultation-area-filter'>
                Área jurídica
              </label>
              <Select
                value={areaId}
            ...
            <div className='space-y-1.5'>
              <label
                ...
                htmlFor='consultation-topic-filter'
              >
                Tema jurídico
              </label>
              <Select
