  ...
  return (
    <div className='relative overflow-hidden bg-card'>
      ...
      <div className='bg-secondary/35 p-4 sm:p-6'>
        <div className='relative mx-auto min-h-[28rem] max-w-3xl rounded-md border bg-card shadow-sm'>
          <EditorContent
            editor={editor}
            ...
            <div className='pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-3 p-6 text-center'>
              ...
              <div>
                <p className='font-medium text-foreground'>
                  Ainda não há conteúdo no template
                </p>
                <p className='mx-auto mt-1 max-w-sm text-sm text-muted-foreground'>
                  Comece a escrever o documento ou insira uma variável para montar o
