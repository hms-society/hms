...
describe('Document specification page widgets', () => {
  ...
  it('filters system and local variables by accessible metadata', async () => {
    ...
    expect(
      screen.queryByRole('button', { name: 'Remover variável Nome do cliente' }),
    ).toBeNull()
    expect(
      (
  ...
  it('requires confirmation before removing a variable', () => {
    ...
    const customVariable = {
      ...
      technicalName: 'nome_personalizado',
      description: 'Campo local do modelo.',
    }
    render(
      <VariablePicker
    ...
    fireEvent.click(
      screen.getByRole('button', { name: 'Remover variável Nome personalizado' }),
    )
