...
import { useDocumentCatalogQuery } from '@/ui/document-production/widgets/pages/document-specifications-page/use-document-catalog-query'
import { useDocumentTopicsQuery } from '@/ui/document-production/widgets/pages/document-specifications-page/use-document-topics-query'
