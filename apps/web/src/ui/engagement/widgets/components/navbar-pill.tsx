      ...
      <div className="flex items-center gap-3">
        ...
        >
          <Avatar size="default" className="border border-white/20">
            <AvatarImage src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80" alt="Usuário" />
            <AvatarFallback className="bg-white/10 text-white font-sans text-xs">US</AvatarFallback>
          </Avatar>
        </button>
      </div>
    </nav>
