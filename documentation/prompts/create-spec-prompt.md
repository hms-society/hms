---
name: create-spec
description: Create or refine an implementation-ready feature Spec from a PRD, Jira ticket, report, existing reference, or direct request, grounded in repository rules and real code paths.
---
...
Record the real source as `prd`, `jira-ticket`, `report` or `direct-request`. Choose depth from
...
request, PRD, Jira ticket, screenshots, routes, permissions, validation states, API fields and
