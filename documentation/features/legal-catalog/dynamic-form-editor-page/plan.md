...
- **Delivery slices:** Slice 1 is the current `feat/dynamic-form-editor-page` branch, based on `feat/dynamic-forms-page`, and contains Core, Validation, Server, migration and compatibility contracts. Slice 2 is `feat/dynamic-form-editor-page-web`, based on Slice 1, and contains the Web routes, hooks, widgets, shared UI corrections and browser coverage.
