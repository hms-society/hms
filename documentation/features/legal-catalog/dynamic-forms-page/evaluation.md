...
| `EV-43` | review | Web | Implementation Reviewer re-audit of canonical head `fa76bdbb383d58c3161f3333876d2ac28042bf98` | Reviewer found the mobile card branch exposed only overflow actions; the required explicit `Editar` action was absent at 320px. The finding is recorded as `FND-027`; no clean Web PR gate was established at that head. | `superseded` |
