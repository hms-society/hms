...
| 7 | [#110](https://github.com/hms-society/hms/pull/110) | `codex/formalization-web-foundation-v3-slice` → `codex/formalization-web-page-v3-slice` | 4,827 | Formalization page and route files | focused Web/page checks; page criteria | published |
