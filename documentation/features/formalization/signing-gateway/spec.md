...
FR-16 ten-second budget. `FormalizationProvisionModule` provides/exports the normalizer and
...
| `apps/server/src/consultation/fixtures/in-memory-file-storage-provider.ts` | Create |
...
| `apps/server/src/document-production/fixtures/document-production-module-fixture.ts` | Modify |
...
| --- | --- | --- |
| AC-01–AC-03 | exchange/channel/request/verify Core tests; transaction/concurrency tests; matching controllers; page/OTP widgets | MV-01, MV-02 |
| AC-04–AC-06 | collaborator/document/acknowledgement Core tests; controllers; login and route tests | MV-03, MV-06 |
| AC-07–AC-09 | provider/proxy tests; submission/result Core tests; service/page/provider/result widgets | MV-02, MV-05, then G-01-gated shared exposure |
| AC-10–AC-13 | webhook/reconciliation/transaction/job tests; migration test | MV-01, MV-04, MV-07 after G-02 |
| AC-14 | all redaction assertions plus repository canary scan | MV-05, MV-08 |
| AC-15 | all widget pairs and route test | MV-06 |
| AC-16 | documentation link/content review | MV-08 |
| AC-17–AC-18 | send review/confirm Core tests; four internal controllers; PostgreSQL transaction race tests; existing configuration and new review widget pairs | MV-01, MV-02, MV-06 |
| AC-19–AC-20 | provisioning/delivery Core and job tests; SignatureProvider contract; Communication invitation job; secret scan | MV-02, MV-04, MV-07 |
| AC-21–AC-22 | cancellation Core/job/controller tests; configuration and cancel-dialog pairs; protected route integration | MV-02, MV-04, MV-06 |
...
| --- | --- |
| Direct 2026-09-03 multi-document package decision | Revision-6 amendment; FR-09, FR-11, FR-19, FR-31–FR-37; AC-05, AC-06, AC-12, AC-18, AC-19, AC-21; provider, persistence, REST, events, widget tree and MV-02. This supersedes the RFC/Jira one-envelope-per-document technical choice and requires follow-up authority alignment before conclusion. |
| Direct sibling/channel/projection decisions | Unified boundary; FR-03, FR-14, FR-30, FR-33, FR-34, FR-38; AC-02, AC-08, AC-18, AC-20; revision-5 persistence, UI and delivery contracts |
| SCRUM-144 client OTP/authentication/session | FR-01 through FR-05, FR-09, FR-10; AC-01 through AC-05 |
| SCRUM-144 collaborator HMS session/eligibility | FR-06 through FR-08; AC-04, AC-06 |
| SCRUM-144 private provider Gateway/no raw link | FR-11 through FR-14; AC-06 through AC-08; MV-05 |
| SCRUM-144 submitted versus confirmed/evidence | FR-15 through FR-23; AC-09 through AC-13 |
| SCRUM-144 fail-closed/accessibility | FR-26, FR-27; AC-15; manifest derived states |
| SCRUM-140 ready-state review and authorization | FR-29, FR-30; AC-17; internal send widget/REST contracts |
| SCRUM-140 request/envelope/recipient/invitation creation | FR-31–FR-35; AC-18–AC-20; Core/provider/transaction/persistence contracts |
| SCRUM-140 cancellation and projections | FR-36–FR-38; AC-21, AC-22; cancel-all job and internal widget contracts |
| Direct provider pin/private Postgres | Technical Contract deployment subsection and G-04 |
| Direct raw-token strictness | FR-12/FR-13, proxy contract, threat model and release-blocking MV-05 |
| Direct AGPL/X.509 gates | G-01/G-02, licensing/key sections and MV-07/MV-08 |
| Direct invite/OTP/session/result defaults | Approved decisions, FR-01/FR-04/FR-05/FR-10/FR-15/FR-23 and persistence algorithms |
| Pencil flow | Technical Contract Web experience subsection plus design/manifest.md |
| Architecture correction | FR-28, AC-16 and implementation tree |
