...
| Server controller/database/seed suites | `CA-01`–`CA-03`, `CA-05`–`CA-11`, `CA-13` | `pnpm --filter server test:integration -- src/formalization` then `pnpm --filter server test:integration` | Real migrations, unique race, persistence/reload, explicit 403, event source, convergence and seed |
