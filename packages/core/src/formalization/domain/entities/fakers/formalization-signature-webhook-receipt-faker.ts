...
export function fakeFormalizationSignatureWebhookReceipt(
  overrides: Partial<FormalizationSignatureWebhookReceipt> = {},
  ...
  return {
    ...
    encryptedHint: faker.string.alphanumeric(32),
