...
export function fakeFormalizationSignatureSnapshot(
  overrides: Partial<FormalizationSignatureSnapshot> = {},
  ...
  return {
    ...
    snapshotHash: faker.string.hexadecimal({ length: 64, prefix: '' }),
