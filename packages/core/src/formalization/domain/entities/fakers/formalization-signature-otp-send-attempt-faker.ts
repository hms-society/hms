...
export function fakeFormalizationSignatureOtpSendAttempt(
  overrides: Partial<FormalizationSignatureOtpSendAttempt> = {},
): FormalizationSignatureOtpSendAttempt {
  return {
    id: faker.string.uuid(),
    challengeId: faker.string.uuid(),
    encryptedPayload: faker.string.alphanumeric(32),
